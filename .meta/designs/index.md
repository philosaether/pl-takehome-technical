...
| [ambitious-head-to-head.md](ambitious-head-to-head.md) | draft | 2026-06-27 | run-cloud-2 — isolated/saturated topology, 1/2/4/8 shards, tuned-PG baseline, durability tradeoff, process sweep 0/2/20/200ms; middle orchestration; $/throughput + p99 analysis |
